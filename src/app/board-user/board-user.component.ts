...
export class BoardUserComponent implements OnInit {
  ...
  clickHandler(pos:any) {
    if(pos == 1) {
      ...
      this.logintime1 = currenttime.toLocaleTimeString('en-US', {day: 'numeric', month: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric' });
    ...
    if(pos == 2) {
      ...
      let currenttime = new Date();
      this.logintime2 = currenttime.toLocaleTimeString('en-US', {day: 'numeric', month: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric' });
    ...
    if(pos == 3) {
      ...
      let currenttime = new Date();
      this.logintime3 = currenttime.toLocaleTimeString('en-US', {day: 'numeric', month: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric' });
